...
def emit(program, opcode, arg_type="none", arg=0):
    program["instructions"].append({"opcode": opcode, "arg_type": arg_type, "arg": arg})
...
def parse_program(tokens):
    program = {"instructions": [], "variables": {}, "data": [0] * 1024, "data_size": 0}
    pos = 0
...
if __name__ == "__main__":
    assert len(sys.argv) == 4, "Wrong arguments: translator.py <input_file> <target_code_file> <target_data_file>"
